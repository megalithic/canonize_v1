defmodule CanonizeWeb.UserAuthTest do
  use CanonizeWeb.ConnCase, async: true

  alias Canonize.Accounts
  alias CanonizeWeb.UserAuth
  import Canonize.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, CanonizeWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      CanonizeWeb.Endpoint.subscribe(live_socket_id)
