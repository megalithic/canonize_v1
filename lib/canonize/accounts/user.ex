defmodule Canonize.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Canonize.Repo)
  ...
  """
  def valid_password?(%Canonize.Accounts.User{hashed_password: hashed_password}, password)
